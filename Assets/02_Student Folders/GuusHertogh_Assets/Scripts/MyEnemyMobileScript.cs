...
public class MyEnemyMobileScript : MonoBehaviour
{
    public enum AIState
    {
        Patrol,
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<EnemyController, MyEnemyMobileScript>(m_EnemyController, this, gameObject);
        ...
        DebugUtility.HandleErrorIfNullGetComponent<AudioSource, MyEnemyMobileScript>(m_AudioSource, this, gameObject);
