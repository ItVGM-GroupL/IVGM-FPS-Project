...
public class MyEnemyTurretScript : MonoBehaviour
{
    public enum AIState
    {
        Idle,
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<Health, MyEnemyTurretScript>(m_Health, this, gameObject);
        m_Health.onDamaged += OnDamaged;

        m_EnemyController = GetComponent<EnemyController>();
        DebugUtility.HandleErrorIfNullGetComponent<EnemyController, MyEnemyTurretScript>(m_EnemyController, this, gameObject);
